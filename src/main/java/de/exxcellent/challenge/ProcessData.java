...
public class ProcessData {
     ...
     */
    public static void processDataOfFile(String source, SourceType type, String id, String val1, String val2) {
     ...
     */
    public static void processWeatherDataOfWebSource(String url) {
        try {
            List<Map<String, String>> weatherData = (List<Map<String, String>>) SourceReaderUtils.readData(url, SourceType.WEB);
            process(weatherData, Constants.weatherIdCaption, Constants.weatherVal1Caption, Constants.weatherVal2Caption);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }

    public static void processFootballDataWeb() {
     ...
     * @param val2 second value to compare (the order is irrelevant)
     */
    private static void process(List<Map<String, String>> data, String id, String val1, String val2) {
